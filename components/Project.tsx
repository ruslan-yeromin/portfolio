  ...
  ({ id, dataTitle, dataDesc, tags, image }) => {
    ...
    return (
      <motion.section
        ...
        className="group dark:bg-white/10 dark:hover:bg-white/20 max-w-[46rem] border border-black/5 rounded-xl overflow-hidden sm:pr-8 relative sm:h-[25rem] mb-3 sm:mb-8 last:mb-0 sm:group-even:pl-10 hover:bg-blue-50 transition-color"
      >
